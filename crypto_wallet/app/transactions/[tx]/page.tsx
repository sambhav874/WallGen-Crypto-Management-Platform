...
const TransactionDetailsPage = () => {
  ...
  return (
    <div className="p-6 bg-gray-900 text-white min-h-screen flex justify-center items-center">
        <Link href={'/transactions'} className="border border-gray-600 absolute top-56 p-6 text-xl bg-gray-800 text-white hover:bg-white hover:text-gray-800 transition-colors duration-300">
        ...
        <DrawerContent className="max-h-full bg-slate-950">
          <div className="mx-auto w-full p-4">
            <DrawerHeader className="text-center">
              <DrawerTitle className="text-white text-3xl underline underline-offset-4">Transaction Details</DrawerTitle>
            ...
            <div className="p-4">
              {details ? (
                <div className="p-4 rounded-lg flex flex-col shadow-md w-full space-y-4 bg-slate-800">
                  {[
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="ml-4 flex justify-between  hover:border-b-2 tracking-wider leading-6 hover:border-gray-400 pb-2 transition-all duration-300 ease-in-out">
            ...
            <DrawerFooter className="flex justify-center">
              <DrawerClose asChild>
                <Button variant="outline" className="border border-gray-600 bg-gray-800 text-white hover:bg-white hover:text-gray-800 transition-colors duration-300">
                  Close
                </Button>
              </DrawerClose>
            </DrawerFooter>
